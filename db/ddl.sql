-- Script DDL para la Inmobiliaria Tres Muebles
...
-- 2. Entidades de Usuario (1:1 y N:M)
...
-- 3. Entidades de Inmuebles (1:N y N:M)
...
-- 4. Operaciones (Citas, Solicitudes, Favoritos)
